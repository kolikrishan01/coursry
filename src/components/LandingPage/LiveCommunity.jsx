    ...
    const chatApp = [
      {
        ...
        msg2: "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
      },
      {
        msg1: "Lorem ipsum dolor sit amet consectetur, adipisicing elit.",
        msg2: "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
...
const MessageComponent = ({ message, index }) => {
  ...
  useEffect(() => {
    const timeout1 = setTimeout(() => {
      setDisplayMsg1(true);
    }, (index + 1) * 3000); // Delay for displaying msg1 after msg2 or component mounts, with incrementing delay for each subsequent message (in milliseconds)

    const timeout2 = setTimeout(() => {
      setDisplayMsg2(true);
    }, (index + 1) * 3000 + 2000); // Delay for displaying msg2 after msg1 (in milliseconds)
