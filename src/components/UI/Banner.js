                ...
                <div class="relative lg:w-6/12 lg:py-24 xl:py-32">
                    ...
                    <form action="" class="w-full mt-12">
                        <div class="relative flex p-1 rounded-full bg-white border border-yellow-200 shadow-md md:p-2">
                            <input placeholder="Search Courses" class="w-full p-4 rounded-full" type="text"/>
...
Search
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 mx-auto bi bi-search text-yellow-900 md:hidden" fill="currentColor"  viewBox="0 0 16 16">
